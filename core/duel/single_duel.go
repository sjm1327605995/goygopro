...
//		pBuf := utils.NewYGOBuffer(deckBuff[:0], binary.LittleEndian)
//		pBuf.Write(
...
//		pBuf := utils.NewYGOBuffer(startBuf[:0], binary.LittleEndian)
//		pBuf.Write(uint8(ocgcore.MSG_START), uint8(0), s.HostInfo.DuelRule,
